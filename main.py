...
class myCharacter:  
  def __init__(self,char_name,char_gender):
   self.name = char_name 
   self.gender = char_gender
   self.HP = 10
   self.damage = 1
  ...
  def losehp():
   ...
   char1 = myCharacter("Samson the Rich", "male")
   char2 = myCharacter("Hitch the Patriot", "male")
   char3 = myCharacter("Eudon the Mighty","female")
   print (char1.name)
   print (char1.gender)
...
#--
CharacterChoosing = input("Which Character Would You like to choose, the three choices are \n Samson the Rich,  Samson is a rich leader, however, he does not have much skills in command, and his troops are not entirely loyal to him. He mostly relies on bribery and diplomatics. \n \n Hitch the Patriot, \n He commands the  loyalty of his people and is a great leader, however he lacks in money. \n \n Eudon the Mighty, is skilled with the sword, he is respected among the common men, and has a considerable amount of money. However, he lacks the ability to command.  \n To chose your character, type a number between 1 - 3. \n 1 - Samson the Rich \n 2 - Hitch the Patriot \n 3 - Eudon the Mighty. \n  ")
